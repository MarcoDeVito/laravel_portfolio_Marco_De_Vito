...
<body class="bg-primary-subtle">
    ...
    <div class="h-100 px-4 py-5 my-5 text-center">
        ...
        <div class="col-lg-6 mx-auto">
            <p class="lead mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae provident sit
                reprehenderit temporibus sunt reiciendis recusandae porro obcaecati velit, libero accusamus rerum beatae
                pariatur ea ipsum eligendi, commodi officia? Quod.</p>
